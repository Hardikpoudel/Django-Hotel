...
class roomSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        picture_path1 = "http://192.168.0.106:8888"+str(picture["photo1"])
        picture["photo1"] = picture_path1
        picture_path2 = "http://192.168.0.106:8888"+str(picture["photo2"])
        picture["photo2"] = picture_path2
        picture_path3 = "http://192.168.0.106:8888"+str(picture["photo3"])
        picture["photo3"] = picture_path3
        picture_path4 = "http://192.168.0.106:8888"+str(picture["photo4"])
